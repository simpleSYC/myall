Vue.component("krugceto", {
    ...
    <g></g>
                                ...
                                <g class="contact-button" transform="translate(239 23)">\
                                    <title> </title>
                                    <circle onclick="OPND(this);"  class="Oval-2-Copy-5" cx="48" cy="48" r="48" style="fill:#5d8ffc;opacity:0.4;"  fill="#00F7FF" opacity=".6"/>
    <g></g>
                                </g>
                            </g>
                            <g class="settings-menu" transform="translate(228 654)">
                                <g class="security-button" transform="translate(120 24)">
                                    <title> </title>
                                    <circle onclick="SHWcontact(this);"  class="Oval-2-Copy-8" cx="48" cy="48" r="48" style="fill:#5d8ffc;opacity:0.4;" fill="#00F7FF" opacity=".6"/>
    <g></g>
                                </g>
                                <g  class="profile-button">
                                    <title> </title>
                                    <circle onclick="SHWcontact(this);" class="Oval-2-Copy-9" cx="48" cy="48" r="48" style="fill:#5d8ffc;opacity:0.4;" fill="#00F7FF" opacity=".6"/>
    <g></g>
                                </g>
                                <g class="contact1-button" transform="translate(240)">
                                    <title> </title>
                                    <circle  onclick="SHWcontact(this);"  class="Oval-2-Copy-10" cx="48" cy="48" r="48" style="fill:#5d8ffc;opacity:0.4;" fill="#00F7FF" opacity=".6"/>
    <g></g>
                                </g>
                            </g>
